...
| Client-side resource | 20% | dist JS+CSS bytes, OCR assets, SafeContext bytes, screenshot outbound | SafeContext 10268 B; screenshot 0 B; product JS+CSS 213912 B uncompressed / 67054 B gzip PROXY; OCR assets 8123867 B | — | bench/performance/raw/t019-t020-performance.json |
| End-to-end latency | 15% | happy-dom stage p50/p95 (not Chrome E2E) | observe p50=3.27 p95=3.51; OCR p50=10.38 p95=28.86 | observe 40; OCR 7 | bench/performance/raw/t019-t020-performance.json |
